(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('i18next'), require('rxjs'), require('@angular/core'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('angular-i18next', ['exports', 'i18next', 'rxjs', '@angular/core', '@angular/platform-browser'], factory) :
    (factory((global['angular-i18next'] = {}),global.i18n,global.rxjs,global.ng.core,global.ng.platformBrowser));
}(this, (function (exports,i18n,rxjs,core,platformBrowser) { 'use strict';

    var i18n__default = 'default' in i18n ? i18n['default'] : i18n;
     ...
     */
    /** @type {?} */
    var I18NEXT_SCOPE = new core.InjectionToken('I18NEXT_SCOPE');
    /** @type {?} */
    var I18NEXT_NAMESPACE = new core.InjectionToken('I18NEXT_NAMESPACE');
    /** @type {?} */
    var I18NEXT_SERVICE = new core.InjectionToken('I18NEXT_SERVICE');
    /** @type {?} */
    var I18NEXT_NAMESPACE_RESOLVER = new core.InjectionToken('I18NEXT_NAMESPACE_RESOLVER');
    /** @type {?} */
    var I18NEXT_ERROR_HANDLING_STRATEGY = new core.InjectionToken('I18NEXT_ERROR_HANDLING_STRATEGY');
    ...
    ***************************************************************************** */
    ...
    var I18NextPipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        I18NextPipe.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Inject, args: [I18NEXT_SERVICE,] }] },
                { type: undefined, decorators: [{ type: core.Inject, args: [I18NEXT_NAMESPACE,] }] },
                { type: undefined, decorators: [{ type: core.Inject, args: [I18NEXT_SCOPE,] }] }
            ];
        };
        return I18NextPipe;
    }());
    ...
    var I18NextCapPipe = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        I18NextCapPipe.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Inject, args: [I18NEXT_SERVICE,] }] },
                { type: undefined, decorators: [{ type: core.Inject, args: [I18NEXT_NAMESPACE,] }] },
                { type: undefined, decorators: [{ type: core.Inject, args: [I18NEXT_SCOPE,] }] }
    ...
    var I18NextFormatPipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        I18NextFormatPipe.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Inject, args: [I18NEXT_SERVICE,] }] }
            ];
        };
    ...
    var I18NextEvents = /** @class */ (function () {
        function I18NextEvents() {
            ...
            this.failedLoading = new rxjs.Subject();
            this.missingKey = new rxjs.Subject();
            this.added = new rxjs.Subject();
            this.removed = new rxjs.Subject();
            this.languageChanged = new rxjs.BehaviorSubject(null);
        }
    ...
    var I18NextService = /** @class */ (function () {
        ...
        /** @nocollapse */
        I18NextService.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Inject, args: [I18NEXT_ERROR_HANDLING_STRATEGY,] }] }
            ];
        };
    ...
    var I18NextTitle = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        I18NextTitle.ctorParameters = function () {
            return [
                { type: I18NextPipe },
    ...
    exports.i18nextNamespaceResolverFactory = i18nextNamespaceResolverFactory;
    exports.defaultInterpolationFormat = defaultInterpolationFormat;
    exports.I18NextModule = I18NextModule;
    exports.I18NEXT_SCOPE = I18NEXT_SCOPE;
    exports.I18NEXT_NAMESPACE = I18NEXT_NAMESPACE;
    exports.I18NEXT_SERVICE = I18NEXT_SERVICE;
    exports.I18NEXT_NAMESPACE_RESOLVER = I18NEXT_NAMESPACE_RESOLVER;
    exports.I18NEXT_ERROR_HANDLING_STRATEGY = I18NEXT_ERROR_HANDLING_STRATEGY;
    exports.I18NextPipe = I18NextPipe;
    exports.I18NextCapPipe = I18NextCapPipe;
    exports.I18NextFormatPipe = I18NextFormatPipe;
    exports.I18NextService = I18NextService;
    exports.I18NextTitle = I18NextTitle;
    exports.NativeErrorHandlingStrategy = NativeErrorHandlingStrategy;
    exports.StrictErrorHandlingStrategy = StrictErrorHandlingStrategy;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=angular-i18next.umd.js.map